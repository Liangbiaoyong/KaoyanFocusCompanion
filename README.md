...
<p align="center">
  <img src="docs/screenshots/pet.png" width="200" alt="桌宠" />
  &nbsp;&nbsp;&nbsp;
  <img src="docs/screenshots/pet-collapsed.png" width="200" alt="收起后的精简读数" />
</p>

<p align="center">
  <sub>桌宠（左）与收起后的精简读数（右）—— 收起时只剩一个状态圆点、今日计时和一句话</sub>
</p>
...
**山**：山巅是考试那一天。你的海拔 = 累计专注 ÷（剩余天数 × 每日目标），
...
293 个用例，覆盖共享核心、判定分层、文件存储、探针解析、样本映射、时段合并与跨天切分、
